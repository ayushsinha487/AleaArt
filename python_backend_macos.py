#!/usr/bin/env python3
"""
AleaArt Python Backend for Image Generation (macOS Compatible)
    ...
    if pipe is None:
        ...
        try:
            ...
            try:
                ...
                pipe = pipe.to("cpu")
                print("Model loaded on CPU (alternative method)")
...
def index():
    """Root endpoint"""
    return jsonify({
        'message': 'AleaArt Python Backend (macOS Compatible)',
        'endpoints': [
            '/generate-image',
            '/health',
...
if __name__ == '__main__':
    print("Starting AleaArt Python Backend (macOS Compatible)...")
